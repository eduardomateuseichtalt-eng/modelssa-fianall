  ...
  return (
    <div className="page">
      ...
      <p className="muted" style={{ marginTop: 12, maxWidth: 720 }}>
        Somos uma plataforma premium inspirada no mercado de an\u00fancios de
        acompnhantes de alto padr\u00e3o. Conectamos modelos e anunciantes em
        um ambiente seguro, com verifica\u00e7\u00e3o manual e foco em
        experi\u00eancia.
      </p>
